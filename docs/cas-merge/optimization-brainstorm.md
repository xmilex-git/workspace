...
### D6. 통계 재최적화 동안 기존의 유효한 계획 사용을 허용한다

사용자는 Q4에 "허용"이라고 답했다. 통계만 바뀌어 기존 계획의 의미가 여전히 유효한 경우, 첫 요청 하나가 새 계획을 준비하는 동안 다른 실행은 기존 계획을 사용할 수 있다. 새 계획을 완성하고 의존성을 재검증한 뒤 교체한다. DDL·권한 변경으로 hard-invalid가 된 계획에는 적용하지 않는다.

### D7. 열린 유휴 문장 핸들의 큰 계획 객체를 회수·재준비할 수 있다
