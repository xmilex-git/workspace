...
**승인 결과(#327, 2026-09-22, D-327-01~11 — 전건 결정)**: R-1 철회 채택(CHAR 미러 유지, D-327-01) · R-2 §7 에 넓은 바인드 행(D-327-02) · R-3 A3'/A3''(D-327-03) · R-4 A13/A13'(D-327-04) · R-5 F1-T + S4 to_char(D-327-05) · R-6 U13 §7(D-327-06) · R-7 U7 사슬 공통 타입(D-327-07) · R-8 (a) 게이트 의존 상향 전파 A8''(D-327-08) · R-9 (a) 미러 유지 + TC 65 + 릴리스 노트(D-327-09) · R-10 (a) 문맥별 현행 실패 정책 X1(D-327-10) · R-11 (a) 소비자 도메인 우선(D-327-11). 정본 반영: 규칙표 §0 P1·P2, §2 A3'·A3''·A8''·A13', §3 B7, §4 F1-T·S4·U0·U7·X1, §7 확정. 아래 표는 제안 원문(이력).
