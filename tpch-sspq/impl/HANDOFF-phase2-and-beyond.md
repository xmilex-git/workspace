...
### 통과하지 못한 것은 내가 나중에 쓴 요약 문서다

generation 13~16이 잡은 것은 전부 `PHASE-RECORD-2026-08-05.md`와
`HANDOFF-phase2-and-beyond.md`, 그리고 그 검증용으로 만든 `doc-claim-audit.md`의 결함이다.
측정이 아니라 **내가 손으로 옮겨 적은 서술**이다.
...
네 세대 모두 같은 성격이다 — **검증했다고 말한 범위가 실제 검증한 범위보다 넓었다.**
