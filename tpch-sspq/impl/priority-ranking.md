...
Generated 2026-08-04T10:56:15Z. Pinned norm `tpch-sspq/IMPL-SSOT.md` commit `eccdd1ae58cd733ed3121585146d68b9ae54a73f`, blob `15b42ddca521444fa54b34b0fa8477ed2df643f6` (AMEND-A..G).
...
| `IMP-005` | enabler | — | 0 | listed with lane and rationale, no queue position (enabler) | Enabler with zero runtime effect by construction; it earns its place only as the measurement prerequisite for IMP-009 and IMP-012, whose degree changes cannot be honestly read while the nested-chain trace merge is corrupt. |
...
| 16 | `IMP-017` | diagnostic | required predecessor of IMP-016; inherits its position (section 4-a), never its own benefit score |
| 17 | `IMP-016` | performance | rank 15 |
| 18 | `IMP-004` | performance | rank 16 |
| 19 | `IMP-021` | performance | rank 17 |
| 20 | `IMP-010` | performance | rank 18 |
| 21 | `IMP-008` | performance | rank 19 |
| 22 | `IMP-024` | performance | rank 20 |
| 23 | `IMP-006` | performance | rank 21 |
...
| IMP ID | Query | Predicted effect | Corrected MDE | Verdict |
|---|---|---|---|---|
| `IMP-003` | Q02 | 53.100% | 1.368% | resolvable |
| `IMP-009` | Q05 | 81.070% | 4.458% | resolvable |
| `IMP-011` | Q07 | 72.750% | 35.595% | resolvable |
| `IMP-012` | Q08 | 12.150% | 67.708% | **UNPROVABLE_ON_THIS_HOST** |
| `IMP-013` | Q08 | 10.560% | 67.708% | **UNPROVABLE_ON_THIS_HOST** |
| `IMP-014` | Q09 | 35.171% | 8.541% | resolvable |
| `IMP-015` | Q10 | 23.877% | 24.544% | **UNPROVABLE_ON_THIS_HOST** |
| `IMP-018` | Q11 | 58.430% | 18.194% | resolvable |
| `IMP-019` | Q12 | 5.447% | 4.189% | resolvable |
| `IMP-023` | Q16 | 25.990% | 15.569% | resolvable |
| `IMP-027` | Q19 | 99.177% | 7.054% | resolvable |
| `IMP-029` | Q22 | 20.903% | 8.871% | resolvable |
| `IMP-030` | Q22 | 2.310% | 8.871% | **UNPROVABLE_ON_THIS_HOST** |
| `IMP-031` | Q22 | 2.050% | 8.871% | **UNPROVABLE_ON_THIS_HOST** |
...
- Base top 5: `IMP-015`, `IMP-009`, `IMP-014`, `IMP-018`, `IMP-027`
- optimistic: `IMP-015`, `IMP-009`, `IMP-018`, `IMP-014`, `IMP-027` — identity changed: False, order changed: True
- pessimistic: `IMP-015`, `IMP-009`, `IMP-014`, `IMP-018`, `IMP-003` — identity changed: True, order changed: True
