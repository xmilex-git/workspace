...
def main():
    ...
    w(f"| Blocks per query (pinned minimum) | {d['blocks_per_query_pinned_minimum']} |")
    w(f"| paired CV pairing (pinned, section 6-d-1 step 2) | {d['paired_cv_pinned_pairing_blocks']} blocks; blocks beyond it are recorded but NOT used by paired_cv |")
