...
"""
TPCH-SSPQ implementation campaign (tpch-sspq-impl-r1-20260803) — WARM establishment.
Campaign-local adaptation (section 8-b); the WARM proof requirement is IMPL-SSOT section 3-c.
...
# Section 6-a-2: the inherited `/tmp` default is replaced by the pinned
# campaign temp directory, asserted rather than defaulted.
