...
"""
TPCH-SSPQ implementation campaign (tpch-sspq-impl-r1-20260803) — pre-run load gate.
Campaign-local adaptation (section 8-b); the gate is IMPL-SSOT section 3-a / AMEND-D.
